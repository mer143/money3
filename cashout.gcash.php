...
<nav class="navbar navbar-expand-sm bg-success justify-content-center">
      ...
      <div class="container p-5 my-5 border" style="background-color:lightblue;">
      <center>
      ...
      <a href="investment.php"><button type="button" class="btn btn-primary" style="margin-bottom:15px;">Back</button></a>
      <a href="transaction.php"><button type="button" class="btn btn-primary" style="margin-bottom:15px;">Transaction History</button></a>
      <a href="cashout.maya.php"><button type="button" class="btn btn-success" style="margin-bottom:15px;">Maya <i class="fa-solid fa-right-left"></i></button></a>
      ...
      <div class="card" style="width:300px">
          ...
          <div class="card-body">
            <h1 class="card-title" style="text-align:center; background-color:lightblue;">Gcash</h1>
            <p class="card-text"></p>
 <form action="/action_page.php">
  <div class="mb-3 mt-3">
    <label for="text" class="form-label"><b style="color:blue;">Account Name</b></label>
    <input type="text" class="form-control" id="email" placeholder="Enter account name" name="Aname">
  </div>
  <div class="mb-3">
    <label for="number" class="form-label"><b style="color:blue;">Acoount Number</b></label>
    <input type="number" class="form-control" id="pwd" placeholder="Enter account number" name="Anumber" >
  </div>
  <div class="mb-3">
    <label for="number" class="form-label"><b style="color:blue;">Amount / 100-10000</b></label>
  ...
  <button disabled class="btn btn-primary" data-bs-toggle="popover" title="Not Enough Money" data-bs-content="Please Check you Balance!" >cashout</button>
</div>
