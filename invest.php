...
<center>
        <a href="investment.php"><button type="button" class="btn btn-warning" style="margin-top:15px;">Back</button></a>
        <h2>no Investment History</h2>
        <i class="fa-solid fa-coins" style="color:white; font-size:2rem;"></i>
        </center>
